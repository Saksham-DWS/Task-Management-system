...
export const GOAL_STATUS_COLORS = {
  [GOAL_STATUS.PENDING]: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400',
  [GOAL_STATUS.ACHIEVED]: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400',
  [GOAL_STATUS.REJECTED]: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'
}
