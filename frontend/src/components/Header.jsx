...
export default function Header() {
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 transition-colors">
      {/* Search */}
      <div className="flex-1 max-w-xl">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search groups, projects, tasks..."
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
          />
        </div>
      </div>
